  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- USER MANAGEMENT -->
        <li class="nav-item has-treeview <?php currenturl('newuser', 'menu-open'); currenturl('users', 'menu-open'); ?>">
          <a href="#" class="nav-link <?php currenturl('newuser', 'active'); currenturl('users', 'active'); ?>">
        ...
        <!-- LOANS MANAGEMENT -->
        <li class="nav-item has-treeview <?php currenturl('request', 'menu-open'); currenturl('jadwal', 'menu-open'); ?>">
          <a href="#" class="nav-link <?php currenturl('request', 'active'); currenturl('jadwal', 'active'); ?>">
